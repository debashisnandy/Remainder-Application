...
import com.appsbyr.rexoni.meeting_reminder.BuildConfig;
...
public class Constants {
    ...
    static final List<Intent> POWERMANAGER_INTENTS = Arrays.asList(
            ...
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.N ? new Intent().setComponent(new ComponentName("com.coloros.safecenter", "com.coloros.safecenter.startupapp.StartupAppListActivity")).setAction(Settings.ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS).setData(Uri.parse("package:"+ MyApplication.instance.getBaseContext().getPackageName())) : null,
